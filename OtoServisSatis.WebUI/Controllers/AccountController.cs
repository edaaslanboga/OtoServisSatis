...
namespace OtoServisSatis.WebUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            var email=User.FindFirst(System.Security.Claims.ClaimsTypes.Email)?.Value;
            var uguid = User.FindFirst(System.Security.Claims.ClaimsTypes.Email)?.Value;
        ...
        [HttpPost]
        public async Task<  IActionResult> Login(CustomerLoginViewModel customerViewModel)
        {
            try
            {
