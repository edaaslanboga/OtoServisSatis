...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        private readonly IService<Rol> _serviceRole;

        public LoginController(IService<Kullanici> service, IService<Rol> serviceRole)
        {
            _service = service;
        ...
        public async Task<IActionResult> Index(string email,string password)
        {
            try
            {
                ...
                {
                    var rol = _serviceRole.Get(r=>r.Id == account.RolId);
